        ...
        <div className="mb-1 flex flex-col justify-between">
            <div className='flex justify-between'>
                <div>
                    ...
                    <h2 className="block font-sans text-2xl pb-3 font-bold leading-snug tracking-normal text-black antialiased">EGP {properties.price.toLocaleString('us-US', { style: 'currency', currency: 'USD' })}</h2>
