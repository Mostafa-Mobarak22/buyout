                ...
                <div className="flex items-center gap-x-6">
                    ...
                    <Link to={"/edituser/"+value.id} className="text-gray-950 transition-colors duration-200 dark:hover:text-yellow-500 hover:text-yellow-500 focus:outline-none">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
                            ...
                            {/* <tr>
                            <td className="px-4 py-4 text-sm text-gray-950 whitespace-nowrap">25</td>
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-950 ">Olivia Wathan</h2>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-950 whitespace-nowrap">oliviawathan@example.com</td>
                                <td class="px-4 py-4 text-sm text-gray-950 whitespace-nowrap">01559305663</td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center gap-x-6">
                                        <button class="text-gray-950 transition-colors duration-200 dark:hover:text-red-500 hover:text-red-500 focus:outline-none">
                                        ...
                                        <button class="text-gray-950 transition-colors duration-200 dark:hover:text-yellow-500 hover:text-yellow-500 focus:outline-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-5 h-5">
...
{/* 
    <div class="flex items-center justify-between mt-6">
        ...
        <div class="items-center hidden lg:flex gap-x-3">
            ...
            <a href="#" class="px-2 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 hover:bg-gray-100">2</a>
            <a href="#" class="px-2 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 hover:bg-gray-100">3</a>
            <a href="#" class="px-2 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 hover:bg-gray-100">...</a>
            <a href="#" class="px-2 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 hover:bg-gray-100">12</a>
            <a href="#" class="px-2 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 hover:bg-gray-100">13</a>
            <a href="#" class="px-2 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 hover:bg-gray-100">14</a>
        </div>
