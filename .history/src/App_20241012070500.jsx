...
function App() {
  ...
  const route = createBrowserRouter([
    ...
    {path:"admin",element: <ProdectedRoute><Pricing/></ProdectedRoute><AllModel/>,children:[
      {path: "edituser/:id", element: <ProdectedRoute><Pricing/></ProdectedRoute><EditUser/>},
      {path: "alluser",element: <ProdectedRoute><Pricing/></ProdectedRoute><AllUser/>},
      {path: "allproperty",element: <ProdectedRoute><Pricing/></ProdectedRoute><AllProperty/>},
      {path: "editproperty/:id",element: <ProdectedRoute><Pricing/></ProdectedRoute><EditProperty/>},
    ]}
  ])
