...
<Link to={"/propertypage/"+properties.id}>
    <div className="rounded-xl overflow-hidden rounded-b-none bg-blue-gray-500 bg-clip-border text-white shadow-md shadow-blue-gray-500/40">
        <Slider {...settings}>
            {
                [1,1,1,1,1].map((e)=>{
                    return <img className='w-100 h-[300px]' src={properties.image} alt="ui/ux review check"/>
                })
            }
        </Slider>
    </div>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-2">
            ...
            <span className="grow">
                <svg
                    ...
                    fill="currentColor"
                    aria-hidden="true"
                    onClick={(e)=>{e.currentTarget.classList.toggle("text-red-500");addToWishList(properties.id,(localStorage.getItem("user_id")),flag);setflag(!flag);}}
