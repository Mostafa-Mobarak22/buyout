...
import mostafa from '../../assets/WhatsApp Image 2024-09-11 at 8.14.16 PM.jpeg(2).png'
import micheal from '../../assets/WhatsApp Image 2024-09-11 at 8.14.16 PM.jpeg.png'
import ahmed from '../../assets/profile-photo1.jpg'
function ContactUs() {
  return <>
    ...
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
            <div class="flex flex-col shadow-2xl items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-[#398378]">
                <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={mostafa} alt=""/>
            ...
            <div class="flex flex-col shadow-2xl items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-[#398378]">
                <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={ahmed} alt=""/>
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize group-hover:text-white">Ahmed Mohamed</h1>
                <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Full stack developer</p>
                <div class="flex mt-3 -mx-2">
                    <a href="https://www.linkedin.com/in/mostafa-mobarak-5b2483288" target='_blank' class="mx-2 text-gray-600 hover:text-gray-500 group-hover:text-white" aria-label="LinkedIn">
                    <i class="fa-brands fa-linkedin text-2xl rounded-full"></i>
            ...
            <div class="flex flex-col shadow-2xl items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-[#398378]">
                <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={micheal} alt=""/>
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize group-hover:text-white">Michael Awad</h1>
                <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Full stack developer</p>
                <div class="flex mt-3 -mx-2">
                    <a href="https://www.linkedin.com/in/mostafa-mobarak-5b2483288" target='_blank' class="mx-2 text-gray-600 hover:text-gray-500 group-hover:text-white" aria-label="LinkedIn">
                    <i class="fa-brands fa-linkedin text-2xl rounded-full"></i>
