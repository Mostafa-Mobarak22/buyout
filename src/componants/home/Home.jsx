...
export default function Home() {
  ...
  function search(){
    ...
    let x = (properties.filter((property)=>{ 
      ...
      // const matchPropertyBed =((searchArr[3].property_bed=="") || property.property_bed ==  searchArr[3].property_bed)
      // const matchsearchValue = ((searchArr[0].searchValue=="")) || property.location.toLowerCase().includes(searchArr[0].searchValue.toLowerCase()) 
      // const matchPropertyType =((searchArr[1].property_type=="") || property.property_type ==  searchArr[1].property_type)
      // const matchPropertyBath =((searchArr[2].property_bath=="") || property.property_bath ==  searchArr[2].property_bath)
      // const matchPropertyBed =((searchArr[3].property_bed=="") || property.property_bed ==  searchArr[3].property_bed)
      // const matchPropertyBuy =((searchArr[4].property_buy=="") || property.property_buy ==  searchArr[4].property_buy)
      // const matchPropertyArea =((searchArr[5].property_area=="") || property.property_area ==  searchArr[5].property_area)
      // const matchPropertyMaxPrice =((searchArr[6].property_maxprice == "") || property.price <=  searchArr[6].property_maxprice)&&(!(searchArr[7].property_minprice == "") || property.price >=  searchArr[7].property_minprice)
      // // const matchPropertyMinPrice =
      // return matchsearchValue && matchPropertyType && matchPropertyBath && matchPropertyBed && matchPropertyBuy && matchPropertyArea && matchPropertyMaxPrice 
        // return matchPropertyBed
    }))
