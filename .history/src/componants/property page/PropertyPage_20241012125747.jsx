...
{!(property) ? <Loading/>:
 <div className="container pt-5">
    <div className='grid grid-cols-3 mb-10 mx-auto'>
        <div className='col-span-3 lg:col-span-2 h-50  rounded-lg'>
            <Slider {...settings}>
                {
                    [1,1,1,1,1].map((e)=>{
                        return <img className='h-screen' src={property.image} alt="ui/ux review check"/>
                    })
                }
            </Slider>
        </div>
        <div className='lg:flex lg:flex-col hidden'>
            <div >
                <Slider {...settings} className="">
                    {
                        [1,1,1,1,1].map((e)=>{
                            return <img className='h-[50vh]' src={property.image} alt="ui/ux review check"/>
                        })
                    }
                </Slider>
            </div>
    ...
    <div className='grid grid-cols-3 mt-24 mx-auto mb-40 gap-4'>
        <div className='col-span-3  lg:col-span-2 '>
            <div className='flex md:flex-row flex-col justify-between pb-3'>
                <div>
                    <h1 className='font-extrabold text-4xl p-3'>EGP {property.price.toLocaleString('en-EG', { style: 'currency', currency: 'EGP' })}</h1>
                </div>
