...
<div class="relative overflow-hidden col-span-2 flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-screen w-full max-w-[16rem]  py-4 shadow-xl shadow-blue-gray-900/5">
  <div class="mb-2 p-4">
