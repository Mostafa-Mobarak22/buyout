...
<div className='relative  w-screen h-screen'>
  ...
  <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl">Search to Find Your Property </h1>
  ...
  <div className='bg-black/50 mt-10 translate-x-[50%] p-3 flex flex-col translate-y-[-50%] rounded-xl absolute top-[50%] right-[50%] '>
    ...
    <div className='flex flex-col sm:flex-row gap-3'>
      <div id='commercial-list' hidden={usage=="Residential"}>
          ...
          <div id="commercial"  class="z-10 mt-1 absolute hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-56">
      ...
      <div id='residential-list' hidden={usage=="Commercial"}>
          ...
          <div id="residential"  class="z-10 mt-1 absolute hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-56">
            <ul class="py-1 text-sm flex justify-between flex-wrap text-gray-700 ">
            {
