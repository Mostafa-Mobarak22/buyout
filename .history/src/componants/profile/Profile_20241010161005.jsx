...
<div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-lg">
        <form className="space-y-6" onSubmit={handleSubmit} encType='multipart/form-data'>
            ...
            <div>
            <Link to={profileData.is_member ? "/addproperty/"+id : "/pricing/{}/:name"}> <button  className="flex w-full justify-center rounded-md px-3 py-2 text-lg border-2 border-solid border-[#398378] font-semibold leading-6 text-[#398378] shadow-sm hover:bg-[#398378] hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 duration-[0.5s]">Add Property </button></Link>
            </div>
        </form>
    </div>
</div>
