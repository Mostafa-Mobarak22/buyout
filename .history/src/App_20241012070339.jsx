...
function App() {
  ...
  const route = createBrowserRouter([
      ...
      {path: "addproperty/:id",element: <ProdectedRoute><Profile/></ProdectedRoute><AddPropertyForm/>},
      {path:"propertypage/:id",element: <ProdectedRoute><Profile/></ProdectedRoute><PropertyPage/>},
      {path:"wishlist",element: <ProdectedRoute><Profile/></ProdectedRoute><WishList/>},
      {path:"pricing/:id/:name",element: <ProdectedRoute><Profile/></ProdectedRoute><Pricing/>},
