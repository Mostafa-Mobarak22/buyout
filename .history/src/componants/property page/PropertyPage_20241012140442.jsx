...
{!(property) ? <Loading/>:
 <div className="container pt-5">
    ...
    <div className='grid grid-cols-3 mt-24 mx-auto mb-40 gap-4'>
        <div className='col-span-3  grid grid-cols-3 lg:col-span-2 '>
            ...
            <div className='pt-10 colsp'>
            <h2 className='text-2xl font-bold col-span-3'>More available in the same type</h2>
            <div className='pt-5 w-[24.5rem] flex flex-col lg:flex-row  gap-5 col-span-1'>
            {
